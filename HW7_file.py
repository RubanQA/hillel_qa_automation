...
#Preconditions
r_file = open("random_numbers.txt", "w+")
r_file.close()
...
#Preconditions
r_file = open("random_text.txt", "w+")
r_file.close()

with open('random_text.txt', 'rt') as f:
    text = f.read()
    words = text.split()
...
#Preconditions
file = open("numbers_with_space.txt", "w+")
file.close()

f = open('numbers_with_space.txt')
...
#Preconditions
file = open("top_5_strings.txt", "w+")
file.close()

from collections import Counter

f = open("top_5_strings.txt")
